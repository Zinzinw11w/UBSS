          ...
          const mockData = [
            {
              ...
              pair: 'BTC/USD',
              country: 'Bitcoin',
              value: formatPrice(cryptoData.bitcoin?.usd || 111690.14, 2),
              change: formatPercentage(cryptoData.bitcoin?.usd_24h_change || 1.52),
            ...
            },
            {
              ...
              pair: 'ETH/USD',
              country: 'Ethereum',
              value: formatPrice(cryptoData.ethereum?.usd || 4105.68, 2),
              change: formatPercentage(cryptoData.ethereum?.usd_24h_change || 2.11),
